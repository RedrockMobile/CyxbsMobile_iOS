...
- (void)configureView {
    ...
    splitLine.backgroundColor = [UIColor dm_colorWithLightColor:RGBColor(42, 78, 132, 0.1) darkColor:UIColor.clearColor];
...
- (UIView *)whiteView {
    if (_whiteView == nil) {
        ...
        _whiteView.backgroundColor = [UIColor dm_colorWithLightColor:UIColor.whiteColor darkColor:RGBColor(44, 44, 44, 1)];

...
//    }
    ...
    lazy private var buttonBoard: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(.dm ,light: UIColor(hexString: "#FFFFFF")!, dark: UIColor(hexString: "#000000")!)
    ...
    lazy private var findByEmailButton: UIButton = {
        ...
        button.setTitleColor(UIColor(.dm ,light: UIColor(hexString: "#14305B")!, dark: UIColor(hexString: "#FFFFFF")!), for: .normal)

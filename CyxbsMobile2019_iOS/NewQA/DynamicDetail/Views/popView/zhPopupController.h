...
typedef NS_ENUM(NSUInteger, zhPopupMaskType) {
    zhPopupMaskTypeBlackBlur = 0, // 黑色半透明模糊效果
    zhPopupMaskTypeWhiteBlur, // 白色半透明模糊效果
    zhPopupMaskTypeWhite,// 纯白色
    zhPopupMaskTypeClear,// 全透明
    zhPopupMaskTypeBlackTranslucent // 默认黑色半透明效果
};
...
typedef NS_ENUM(NSInteger, zhPopupSlideStyle) {
    zhPopupSlideStyleFromTop = 0,// 从上部滑出
    zhPopupSlideStyleFromBottom,// 从底部滑出
    zhPopupSlideStyleFromLeft,// 从左部滑出
    zhPopupSlideStyleFromRight, // 从右部滑出

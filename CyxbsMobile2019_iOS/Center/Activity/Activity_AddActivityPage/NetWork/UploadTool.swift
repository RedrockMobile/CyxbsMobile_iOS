...
typealias ActivityUploadClientResponse = (Any?) -> Void

class ActivityUploadClient: NSObject {
    
    static let shared = ActivityUploadClient()
    ...
    func upload(
        ...
        fileName: String?,
        mimeType: String?,
        completion: @escaping ActivityUploadClientResponse,

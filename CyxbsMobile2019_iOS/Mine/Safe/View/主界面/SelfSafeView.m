...
- (void)layoutSubviews {
    ...
    [_backBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(SCREEN_HEIGHT * 0.0228 + SCREEN_HEIGHT * 0.0567);
    }];
    [_backBtn setImageEdgeInsets:UIEdgeInsetsMake(SCREEN_HEIGHT * 0.0567, SCREEN_WIDTH * 0.0453, 0, 0)];

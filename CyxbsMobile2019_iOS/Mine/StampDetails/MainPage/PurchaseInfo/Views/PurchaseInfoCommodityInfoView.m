//
//  PurchaseInfoCommodityInfoView.m
//  Details
//
...
@interface PurchaseInfoCommodityInfoView ()
...
@implementation PurchaseInfoCommodityInfoView
...
- (UILabel *)createLabel {
    ...
    label.textColor = [UIColor colorNamed:@"21_49_91_1"];
...
- (void)setCommodityName:(NSString *)commodityName
    ...
    _dict = @{
        _ary[0] : commodityName,
        _ary[1] : [NSString stringWithFormat:@"%@邮票", @(commodityPrice)],
        _ary[2] : tradingTime,

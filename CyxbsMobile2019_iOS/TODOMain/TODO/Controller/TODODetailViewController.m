...
- (void)viewDidLoad {
    ...
    [rightbutton setTitleColor:[UIColor colorNamed:@"41_35_210&44_222_255"] forState:UIControlStateNormal];
    ...
    [_savebutton setTintColor:[UIColor colorNamed:@"41_35_210&44_222_255"]];
    ...
    _detailremindtime.textColor = [UIColor colorNamed:@"21_49_91&240_240_242"];
    ...
    _detailrepeattime.textColor = [UIColor colorNamed:@"21_49_91&240_240_242"];
    ...
    _detailremark.textColor = [UIColor colorNamed:@"21_49_91&240_240_242"];
   ...
   // _detailtimeselect.titleLabel.text = self.detailtimecontent;
    [_detailtimeselect setTitle:@"设置提醒时间" forState:UIControlStateNormal];
     [_detailtimeselect setTitleColor:[UIColor colorNamed:@"21_49_91&240_240_242"] forState:UIControlStateNormal];
...
-(UIButton *)detailsurebtn{
    if(!_detailsurebtn){
        ...
        _detailsurebtn.backgroundColor = [UIColor colorNamed:@"41_35_210&44_222_255"];
...
-(UIButton *)detailrepeatbtn{
    if(!_detailrepeatbtn){
        ...
        [_detailrepeatbtn setTitleColor:[UIColor colorNamed:@"21_49_91&240_240_242"] forState:UIControlStateNormal];
...
-(UIButton *)detailcancelbtn{
    if(!_detailcancelbtn){
        ...
        [_detailcancelbtn setTitleColor:[UIColor colorNamed:@"21_49_91&240_240_242"] forState:UIControlStateNormal];
        _detailcancelbtn.backgroundColor = [UIColor colorNamed:@"237_244_253&72_74_77"];

//
//  CQUPTMapDetailPercentDrivenController.m
//  CyxbsMobile2019_iOS
//
//  Created by 方昱恒 on 2020/8/14.
...
@interface CQUPTMapDetailPercentDrivenController ()
...
@implementation CQUPTMapDetailPercentDrivenController
...
//    _lastTranslationY = translation.y;
    ...
    // 如果是下拉
    if ([[self.transitionContext viewControllerForKey:UITransitionContextToViewControllerKey] isMemberOfClass:[CQUPTMapViewController class]]) {

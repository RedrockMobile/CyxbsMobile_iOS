...
<<<<<<< HEAD
       [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat: @"be-prod.redrock.team/magipoke-jwzx/jwNews/file?id=%@",self.fileIDArray[indexPath.row]]]];
=======

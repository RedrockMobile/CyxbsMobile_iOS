...
- (void)configTODOModel:(TODOModel *)model {
    ...
    if (model.isDone) {
        ...
        self.nameL.textColor = [UIColor colorNamed:@"112,129,155,1"];
        self.timeL.textColor = [UIColor colorNamed:@"112,129,155,1"];
    } else {
        self.nameL.textColor = [UIColor colorNamed:@"21,49,91,1"];
        self.timeL.textColor = [UIColor colorNamed:@"21,49,91,1"];
    }

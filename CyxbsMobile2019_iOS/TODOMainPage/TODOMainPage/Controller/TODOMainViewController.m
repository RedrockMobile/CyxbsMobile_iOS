...
-(void)save{
    ...
    alert.view.backgroundColor = [UIColor colorNamed:@"42,78,132,1"];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section == 0) {
        ...
        _tobedonelbl.textColor = [UIColor colorNamed:@"128,128,128,72.8"];
        ...
        _finishlbl.textColor = [UIColor colorNamed:@"21,49,91,1"];
        _finishlbl.text = @"已完成";
...
-(UIView *)shareView{
    if (!_shareView){
        ...
        _shareView.backgroundColor = [UIColor colorNamed:@"255,255,255,1"];
      //  _shareView.backgroundColor = [UIColor redColor];
        ...
        [btn1 setTitleColor:[UIColor colorNamed:@"41,35,210,1"]forState:UIControlStateNormal];
        ...
        [btn2 setTitleColor:[UIColor colorNamed:@"41,35,210,1"]forState:UIControlStateNormal];
        ...
        [_remindtime setTitleColor:[UIColor colorNamed:@"42,78,132,1"]forState:UIControlStateNormal];
        ...
        [_repeatremind setTitleColor:[UIColor colorNamed:@"42,78,132,1"]forState:UIControlStateNormal];
        ...
        _txt.textColor = [UIColor colorNamed:@"21,49,91,1"];
        _txt.backgroundColor = [UIColor colorNamed:@"232,241,252,1"];
...
-(UIButton *)sharesave{
    if(!_sharesave){
        ...
        _sharesave.backgroundColor = [UIColor colorNamed:@"41,35,210,1"];
...
-(UIButton *)saverepeat{
    if(!_saverepeat){
        ...
        _saverepeat.backgroundColor = [UIColor colorNamed:@"41,35,210,1"];
...
-(UIButton *)cancelrepeat{
    if(!_cancelrepeat){
        ...
        _cancelrepeat.backgroundColor = [UIColor colorNamed:@"232,241,252,1"];
...
-(UIButton *)sharecancel{
    if(!_sharecancel){
        ...
        _sharecancel.backgroundColor = [UIColor colorNamed:@"232,241,252,1"];
